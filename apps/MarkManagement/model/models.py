...
class College(models.Model):
    ...
    university = models.ForeignKey(University, on_delete=models.SET_NULL, to_field='id', verbose_name='所在学校表主键',  null=True, blank=True)
...
class Teacher(models.Model):
    ...
    college = models.ForeignKey(College, on_delete=models.SET_NULL, to_field='id', verbose_name='所属学院id',  null=True, blank=True)
...
class Token(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.SET_NULL, to_field='id', verbose_name='所属教师id',  null=True, blank=True)
...
class Major(models.Model):
    ...
    college = models.ForeignKey(College, on_delete=models.SET_NULL, to_field='id',  null=True, blank=True, verbose_name='所在学院id')
...
class Student(models.Model):
    ...
    major = models.ForeignKey(Major, on_delete=models.SET_NULL, to_field='id',  verbose_name='专业id',  null=True, blank=True)
...
class Lesson(models.Model):
    ...
    college = models.ForeignKey(College, on_delete=models.SET_NULL, to_field='id', verbose_name='学院id',  null=True, blank=True)
...
class ClassInfo(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.SET_NULL, to_field='id', verbose_name='教师表id',  null=True, blank=True)
    ...
    lesson = models.ForeignKey(Lesson, on_delete=models.SET_NULL, to_field='id', verbose_name='所属课程组id',  null=True, blank=True)
...
class Class(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    student = models.ForeignKey(Student, on_delete=models.SET_NULL, to_field='id', verbose_name='学生id',  null=True, blank=True)
    ...
    classInfo = models.ForeignKey(ClassInfo, on_delete=models.SET_NULL, to_field='id', verbose_name='课程详细id',  null=True, blank=True)
...
class TitleGroup(models.Model):
    ...
    lesson = models.ForeignKey(Lesson, on_delete=models.SET_NULL, to_field='id', verbose_name='类别所属课程组id',  null=True, blank=True)
...
class Title(models.Model):
    ...
    titleGroup = models.ForeignKey(TitleGroup, on_delete=models.SET_NULL, to_field='id', verbose_name='列的组id',  null=True, blank=True)
    weight = models.IntegerField(verbose_name='权重', default=0)
    classInfo = models.ForeignKey(ClassInfo, on_delete=models.SET_NULL, to_field='id', verbose_name='列的教学班id', null=True, blank=True)
...
class Point(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    classInfo = models.ForeignKey(ClassInfo, on_delete=models.SET_NULL, to_field='id', verbose_name='分数的课程的id',null=True, blank=True)
    student = models.ForeignKey(Student, on_delete=models.SET_NULL, to_field='id', verbose_name='分数的学生id', null=True,blank=True)
